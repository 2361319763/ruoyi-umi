...
export async function getGenCodeList(params?: GenCodeTableListParams) {
  ...
  return request(`/tool/gen/list?${queryString}`, {
    data: params,
    method: 'get',
    headers: {
...
export async function queryTableList(params?: any) {
  const queryString = new URLSearchParams(params).toString();
  return request(`/tool/gen/db/list?${queryString}`, {
    data: params,
    method: 'get',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
...
export async function importTables(tables?: string) {
  return request(`/tool/gen/importTable?tables=${tables}`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function removeData(params: { ids: string[] }) {
  return request(`/tool/gen/${params.ids}`, {
    method: 'delete',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export async function syncDbInfo(tableName: string) {
  return request(`/tool/gen/synchDb/${tableName}`, {
    method: 'GET',
  });
}
...
export async function genCode(tableName: string) {
  return request(`/tool/gen/genCode/${tableName}`, {
    method: 'GET',
  });
}
...
export async function previewCode(id: string) {
  return request(`/tool/gen/preview/${id}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
