...
const sysFilesColumns: ColumnsType<API.Monitor.DiskInfoType> = [
  ...
  },
  {
    ...
    render: (usage) => {
      return (
        <span style={{ color: usage > 80 ? '#dc2626' : '#000000E0' }}>
          {usage}%
        </span>
      );
    },
...
const Server: React.FC = () => {
  let [serverInfoType, setServerInfoType] =
    useState<API.Monitor.ServerInfoType>();
      ...
      <Row gutter={[16, 16]}>
        <Col span={12}>
          <Card
            ...
            style={cardStyle}
          >
            <Descriptions bordered size={size} items={cpuItems} column={1} />
          </Card>
        </Col>
        <Col span={12}>
          <Card
        ...
        <Col span={24}>
          ...
          >
            <Descriptions bordered size={size} items={sysItem} column={2} />
          </Card>
        </Col>
        <Col span={24}>
          <Card
          ...
          >
            <Descriptions bordered size={size} items={javaItem} column={2} />
          </Card>
        </Col>
        <Col span={24}>
          <Card
          ...
          >
            <Table
              ...
              dataSource={serverInfoType?.sysFiles}
              rowKey="dirName"
            />
          </Card>
        </Col>
